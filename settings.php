...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="contaienr rounded-lg border">
                <?php
                ...
                if (mysqli_num_rows($results) > 0) {
                    ...
                    <div class="card">
                        ...
                        <h4 class="card-title text-center"> Username: ' . $row['user_name'] . '</h4>
                            <p class="card-text text-center"> Email: ' . $row['user_email'] . ' </p>
                ...
                <div class="btn-group float-left"><a class="btn btn-outline-danger" href="proD?id=' . $row["user_id"] . '?>"role="button">Delete Account</a>
            </div>
        </div>
        ';
                    }
